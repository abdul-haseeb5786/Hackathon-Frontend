  ...
  return (
    <div className="w-full p-6 bg-white text-black">
      ...
      <Table className="w-full border border-gray-300 text-sm">
        <TableCaption className="text-gray-600 text-center mb-2">A list of managers reports by city and branch.</TableCaption>
        <TableHeader>
            ...
            currentData.map((item, index) => (
              <TableRow key={index} className="hover:bg-gray-50">
                ...
                <TableCell>
                  ...
                  <AlertDialog>
                    <AlertDialogTrigger className="underline">Delete</AlertDialogTrigger>
                    <AlertDialogContent>
                      <AlertDialogHeader>
